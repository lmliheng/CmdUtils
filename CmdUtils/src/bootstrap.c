...
int main(int argc, char *argv[]) {
    if (argc == 1) { // argc参数为1时
        ...
        printf("\033[1;34mcil i * :支持nginx,psql,nvm——安装功能\033[0m\n");
...
// 编译：gcc -I../include src/bootstrap.c src/Utils/cmd_utils.c src/Utils/install_utils.c src/Utils/shell_utils.c -o cil
